...
test("parse archive w/ padding between local files", function (t) {
  var archive = path.join(__dirname, '../testData/padding/archive.zip');
...
test("extract archive w/ padding between local files", function (t) {
  var archive = path.join(__dirname, '../testData/padding/archive.zip');
